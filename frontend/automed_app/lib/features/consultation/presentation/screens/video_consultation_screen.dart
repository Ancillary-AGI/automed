...
class _VideoConsultationScreenState
      ...
      body: consultation.when(
        data: (consultationData) => Stack(
          children: [
            ...
            // Connection Status
            if (webRtcState.connectionState != RTCPeerConnectionState.RTCPeerConnectionStateConnected)
              Positioned(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${S.of(context).with} Dr. ${consultation.doctorName ?? 'Unknown'}',
  ...
  Widget _buildConnectionStatus(dynamic webRtcState) {
    return Container(
          ...
          SizedBox(
            ...
            child: CircularProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                webRtcState.connectionState == RTCPeerConnectionState.RTCPeerConnectionStateConnecting
                    ? Colors.orange
                    : Colors.red,
              ),
            ),
  ...
  void _toggleAudio() {
    ...
    ref.read(webRtcProvider.notifier).toggleAudio(_isAudioMuted);
  }

  void _toggleVideo() {
    setState(() => _isVideoMuted = !_isVideoMuted);
    ref.read(webRtcProvider.notifier).toggleVideo(_isVideoMuted);
  }
