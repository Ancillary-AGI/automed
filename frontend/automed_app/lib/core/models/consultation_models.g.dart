...
ConsultationSession _$ConsultationSessionFromJson(Map<String, dynamic> json) =>
    ConsultationSession(
...
Map<String, dynamic> _$CreateConsultationRequestToJson(
        CreateConsultationRequest instance) =>
    <String, dynamic>{
      'patientId': instance.patientId,
      'providerId': instance.providerId,
      'type': instance.type,
...
Map<String, dynamic> _$UpdateConsultationRequestToJson(
        UpdateConsultationRequest instance) =>
    <String, dynamic>{
      'scheduledTime': instance.scheduledTime?.toIso8601String(),
      'notes': instance.notes,
      'status': _$ConsultationStatusEnumMap[instance.status],
